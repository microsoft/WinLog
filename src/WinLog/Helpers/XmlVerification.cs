...
namespace WinLog.Helpers
{
    ...
    /// <summary>
    /// Static helper class for verifying XML characters as defined in XML specification.
    /// </summary>
    public static class XmlVerification
    {
        ...
        /// <summary>
        ///     Verifies XML characters as defined in XML specification, repairs invalid XML and removes or replaces
        ///     special characters with text representations.
        /// </summary>
