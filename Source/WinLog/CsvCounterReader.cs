...
namespace WinLog
{
    ...
    public class CsvCounterReader
    {
        ...
        // The code here only runs if the prefix is not provided.
        ...
        /// </summary>
        /// <param name="sample">The sample to "fix"</param>
        ...
        /// </summary>
        /// <param name="firstLine">The entire first line from the *.csv file content</param>
