...
namespace WinLog
{
    ...
    /// <summary>
    ///     This class transforms the local Windows event log API for events into typed instances that can be serialized for uploading to a Kusto cluster table.
    /// </summary>
    public class LogReaderLogRecord
    {
        /// <summary>
        /// The number of event already processed. Used for debugging.
        /// </summary>
        public ulong RecordsSoFar; // for debugging

        /// <summary>
        /// Whether to use the JSON filter of the events. Specified by <see cref="JsonFilter"/>.
        /// </summary>
        public bool UseJsonFilter { get; set; }

        /// <summary>
        /// The JSON filter to use to filter the events to process.
        /// </summary>
